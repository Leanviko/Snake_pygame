...
class SNAKE:
        def __init__(self):
                ...
                #sonidos
                self.crunch_sounds = pygame.mixer.Sound('Sound/crunch.wav')
        ...
        def draw_snake(self):
                ...
                #enumerate() permite seguir el indice de cada elemento
                for index, block in enumerate(self.body):
                        #rect para cada posicion
        ...
        def update_head_graphics(self):
                # la resta de vectores me determina la orientacion
...
class MAIN:
        ...
        def draw_score(self):
                ...
                backgr_rect = pygame.Rect(apple_rect.left,apple_rect.top,apple_rect.width + score_rect.width + 9,apple_rect.height)

                pygame.draw.rect(screen,(167,209,200),backgr_rect)
                screen.blit(score_surface, score_rect)
                screen.blit(apple, apple_rect)
                pygame.draw.rect(screen,(56,74,12),backgr_rect,2)
